...
// Simply replace these links anytime to change the sounds instantly!
// ============================================================================
const AUDIO_CONFIG = {
...
export default function App() {
  ...
  // FIXED: All references must start as null to prevent instantiation execution on re-renders
  ...
  // --- FIXED: ONE-TIME RUNTIME INSTANTIATION ENGINE ---
  useEffect(() => {
    // Instantiates audio players EXACTLY ONCE on component mount
